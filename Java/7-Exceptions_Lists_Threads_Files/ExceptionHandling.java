 ...
 * Write a program to take N number as input and output the element of the
 * array with N index. If the index is out of range, program should output
 * "Wrong Option".
 */
...
class Main
{
	public static void main(String[] args)
	{
		...
		String[]	categories = {"PCs", "Notebooks", "Tablets", "Phones",
								  "Аccessories"};
