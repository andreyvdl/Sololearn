 ...
 * The program you are given defines Player class and Difficulty Enum,
 * and creates 3 Player objects with different difficulties as parameters
 * for the constructor.
 * Complete the Player constructor, which takes the Enum as a parameter to
 * check number of bullets for each difficulty option and output the
