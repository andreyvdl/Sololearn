 ...
 * The program you are given defines an abstract class Animal,
 * and has Dog & Cat classes inherited from it.
 * Implement the Swimmer and Player interface and override their
 * methods swim() and play(), so that the given method calls
